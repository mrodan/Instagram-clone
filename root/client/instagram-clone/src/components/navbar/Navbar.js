        ...
        return (
            <div>
                <div className="">
                    ...
                    <Link className="action-icon" to="/direct">
                    ...
                    <Link className="action-icon" to="/explore">
                    ...
                    <Link className="action-icon" to="/notifications">
                    ...
                    <Link to={`/profile/${clientUsername}`}>
